...
import { checkRateLimit, validateEmail, validatePhone, validateName, sanitizeString, } from "../lib/validation.js";
export default async function handler(req, res) {
    ...
    try {
        ...
        const { firstName, lastName, email, phone, country, timezone, howHeard, howHeardOther, childName, childAge, schoolingStructure, ageBand, promptInterest, formationAreas, childTemperament, childAt25, parentInvolvement, structuredEnvironment, faithValues, investmentReady, additionalInfo, } = req.body;
        ...
        const enrollmentData = {
            ...
            formationAreas: formationAreas.map((area) => sanitizeString(area)),
