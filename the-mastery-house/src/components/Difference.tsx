  ...
  return (
    <Section background="dark" id="difference">
      <div className="max-w-3xl mx-auto px-4">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold mb-8 sm:mb-12 text-center">
          What Makes This Different
        </h2>

        <div className="space-y-6 sm:space-y-8 text-base sm:text-lg leading-relaxed">
          <p className="text-xl sm:text-2xl text-center mb-6 sm:mb-8 text-amber-100">
          ...
          <p className="text-xl text-center pt-8 text-amber-100">
